...
class GabProcessor(DataProcessor):
    ...
    def _create_examples(self, data_dir, split, label=None, neutral_words_file=None):
        """
        ...
        """
        terms, subgroups = [], []
        if neutral_words_file:
            with open(neutral_words_file, 'r', encoding='utf-8') as f:
        ...
        for i, line in enumerate(f.readlines()):
            ...
            setattr(example, 'label', data['label'])
    ...
    def get_test_examples(self, data_dir, label=None, neutral_words_file=None):
        return self._create_examples(data_dir, 'test', label, neutral_words_file)
    ...
    def get_dataloader(self, split, batch_size=1, collate_fn=dotdict_collate):
        """
